...
<!-- Mirrored from themes.potenzaglobalsolutions.com/html/mentor-bootstrap-4-admin-dashboard-template/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 29 Jun 2020 09:58:18 GMT -->
...
<head>
    ...
    <!-- plugin stylesheets -->
    <link rel="stylesheet" type="text/css" href="<?= ROOT ?>admin/assets/css/vendors.css" />
    <!-- app style -->
    <link rel="stylesheet" type="text/css" href="<?= ROOT ?>admin/assets/css/style.css" />
