...
<title><?=SITE_NAME?> :: ADVANTAGE</title>
        ...
        <div class="container">
            <div class="page-title-inner">
                <div class="page-title-main-info">
                    <h1>Global Advantage</h1>
                </div>
                <ul class="breadcrumbs">
                    <li><a href="<?= ROOT ?>" class="home">Home</a></li>
                    <li><span>Global advantage</span></li>
                </ul>
            </div>
        </div>
    </section>
                ...
                <article id="post-1002" class="pages post-1002 page type-page status-publish hentry">
                    <div class="entry-content clearfix">
                                    ...
                                    <div class="wpb_column vc_column_container vc_col-sm-12 vc_col-md-6">
                                        <div class="vc_column-inner">
                                            <div class="wpb_wrapper">
                                                <div class="g5plus-space space-5f02f8e887e75" data-id="5f02f8e887e75"
                                                    data-tablet="75" data-tablet-portrait="55" data-mobile="45"
                                                    data-mobile-landscape="45"
                                                    style="clear: both; display: block; height: 95px"></div>
                                                <div class="wpb_text_column wpb_content_element mg-bottom-50">
                                                    <div class="wpb_wrapper">
                                                        <h2 class="fs-32 fw-semi-bold">Buy, sell and invest in<br />
                                                            few seconds with <span class="accent-color">beyot</span>.
                                                        </h2>
                                                        <p class="fs-18 fw-medium" style="color: #8f8f8f;">At Bay Palm Homesour dynamic team of investment specialists will give you the best and most professional advice, without forgetting the personal touch. We can deliver the best prices and yields in every market we work in, we have our finger on the pulse.</p>
                                                    </div>
                                                </div>
                                                <div
                                                    class="g5plus-heading style2 text-left color-dark vc_custom_1480647218530">
                                                    <span></span>
                                                    <h2>Marketing Philosophy</h2>
                                                </div>
                                                <div
                                                    class="wpb_text_column wpb_content_element vc_custom_1480647260611">
                                                    <div class="wpb_wrapper">
                                                        <p class="fs-13">We're on a mission to build a better financial system by empowering the individual.</p>
                                                    </div>
                                                </div>
                                                <div
                                                    class="g5plus-heading style2 text-left color-dark vc_custom_1480647271855">
                                                    <span></span>
                                                    <h2>Administrative Support</h2>
                                                </div>
                                                <div
                                                    class="wpb_text_column wpb_content_element vc_custom_1480647276793">
                                                    <div class="wpb_wrapper">
                                                        <p class="fs-13">Bay Palm Homesoffers unprecedented transparency into what you actually own. Each of our portfolios offers exposure to a mix of some or all of the projects listed, plus ongoing updates about the progress of individual investments.</p>
                                                    </div>
                                                </div>
                                                <div
                                                    class="g5plus-heading style2 text-left color-dark vc_custom_1480647283178">
                                                    <span></span>
                                                    <h2>Individual Selling Plans</h2>
                                                </div>
                                                <div class="wpb_text_column wpb_content_element ">
                                                    <div class="wpb_wrapper">
                                                        <p class="fs-13">Unlike most private real estate investments, our low minimums give you the flexibility to invest the right amount, at the right time, to meet your goals.</p>
                                                    </div>
                                                </div>
                                                <div class="g5plus-space space-5f02f8e888857" data-id="5f02f8e888857"
                                                    data-tablet="70" data-tablet-portrait="50" data-mobile="45"
                                                    data-mobile-landscape="45"
                                                ...
                                                <div class="wpb_single_image wpb_content_element vc_align_center">
                                                    <figure class="wpb_wrapper vc_figure">
                                                        <div class="vc_single_image-wrapper vc_box_border_grey"><img
                                                                width="568" height="667"
                                                                src="https://themes.g5plus.net/beyot/wp-content/uploads/2016/12/background-image-04.png"
                                                                class="vc_single_image-img attachment-full" alt=""
                                                                srcset="https://themes.g5plus.net/beyot/wp-content/uploads/2016/12/background-image-04.png 568w, https://themes.g5plus.net/beyot/wp-content/uploads/2016/12/background-image-04-255x300.png 255w"
                        ...
                        <!-- <div data-vc-full-width="true" data-vc-full-width-init="false"
                                    class="vc_row wpb_row vc_row-fluid vc_custom_1480646477720 vc_row-has-fill">
                                    <div class="wpb_column vc_column_container vc_col-sm-12">
                                        <div class="vc_column-inner">
                                            <div class="wpb_wrapper">
                                                <div class="g5plus-space space-5f02f8e88a0c4" data-id="5f02f8e88a0c4"
                                                    data-tablet="85" data-tablet-portrait="65" data-mobile="45"
                                                    data-mobile-landscape="45"
                                                    style="clear: both; display: block; height: 103px"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div
                                        class="col-mb-12 sm-mg-bottom-45 wpb_column vc_column_container vc_col-sm-6 vc_col-md-3 vc_col-xs-6">
                                        <div class="vc_column-inner">
                                            <div class="wpb_wrapper">
                                                <div class="g5plus-counter color-dark "> <span class="icon"> <i
                                                            class="fa fa-check"></i> </span> <span
                                                        class="counterup p-font" data-start="0" data-end="90"
                                                        data-decimals="0" data-duration="2,5" data-separator=""
                                                        data-decimal="" data-prefix="" data-suffix="+">90</span>
                                    ...
                                    <div
                                        ...
                                        <div class="vc_column-inner">
                                            <div class="wpb_wrapper">
                                                <div class="g5plus-counter color-dark "> <span class="icon"> <i
                                                            class="fa fa-diamond"></i> </span> <span
                                                        class="counterup p-font" data-start="0" data-end="50"
                                                        data-decimals="0" data-duration="2,5" data-separator=""
                                                        data-decimal="" data-prefix="" data-suffix="+">50</span>
                                                    <p>WEB AWARDS</p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div
                                        ...
                                        <div class="vc_column-inner">
                                            <div class="wpb_wrapper">
                                                <div class="g5plus-counter color-dark "> <span class="icon"> <i
                                                            class="icon-hand"></i> </span> <span
                                                        class="counterup p-font" data-start="0" data-end="120"
                                                        data-decimals="0" data-duration="2,5" data-separator=""
                                                        data-decimal="" data-prefix="" data-suffix="+">120</span>
                                                    <p>HAPPY CLIENTS</p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div
                                        ...
                                        <div class="vc_column-inner">
                                            <div class="wpb_wrapper">
                                                <div class="g5plus-counter color-dark "> <span class="icon"> <i
                                                            class="fa fa-coffee"></i> </span> <span
                                                        class="counterup p-font" data-start="0" data-end="250"
                                                        data-decimals="0" data-duration="2,5" data-separator=""
                                                        data-decimal="" data-prefix="" data-suffix="+">250</span>
                                                    <p>CUPS OF COFFEE</p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="wpb_column vc_column_container vc_col-sm-12">
                                        <div class="vc_column-inner">
                                            <div class="wpb_wrapper">
                                                <div class="g5plus-space space-5f02f8e88b0ed" data-id="5f02f8e88b0ed"
                                                    data-tablet="80" data-tablet-portrait="60" data-mobile="0"
                                                    data-mobile-landscape="0"
                                                    style="clear: both; display: block; height: 100px"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div> -->
                        <div class="vc_row-full-width vc_clearfix"></div>
                        <div data-vc-full-width="true" data-vc-full-width-init="false" class="vc_row wpb_row vc_row-fluid vc_custom_1480587972328 vc_row-has-fill vc_row-background-overlay-wrap">
                            <div class="vc_row-background-overlay" style="background-color: rgba(255,255,255,0.7)"></div>
                            <div class="col-mb-12 col-mb-offset-0 wpb_column vc_column_container vc_col-sm-8 vc_col-md-offset-6 vc_col-md-6 vc_col-sm-offset-2 vc_col-xs-offset-1 vc_col-xs-10">
                                <div class="vc_column-inner">
                                    <div class="wpb_wrapper">
                                        <div class="g5plus-space space-5f02f8e88b628" data-id="5f02f8e88b628" data-tablet="80" data-tablet-portrait="60" data-mobile="50" data-mobile-landscape="50" style="clear: both; display: block; height: 100px"></div>
                                        <div class="wpb_text_column wpb_content_element pd-bottom-35">
                                            <div class="wpb_wrapper">
                                                <p>WHAT DIFFERENTIATES Bay Palm HomesFROM OTHER US PROPERTY COMPANIES IS OUR YEARS OF EXPERIENCE AND OUR CAPACITY TO PROVIDE THE BEST INVESTMENT PROPERTIES IN THE BEST CITIES IN THE US. </p>

                                                <p>
                                                    We have a proven track record in the US buy-to-let market, with more than 5000 sales completed over the last decade.</p>

                                                    <p>
                                                    We work exclusively with leading brokers in each city and also work hand in hand with large US Asset Management companies, International Banks and Venture Capital organisations, ensuring our clients get the best choice of investment properties.</p>

                                                    <p>
                                                    The US market is complex and constantly changing, so you want to know that you are working with property investment experts who are ahead of the curve. Through our network of experienced local management companies and comprehensive legal support, we have everything in place to make it easy and efficient for you to invest in the US property market.</p>

                                                    <p>
                                                    Thanks to our extensive connections throughout many of the USA’s most desirable cities, we are able to offer our customers exclusive property stock that you won’t find listed anywhere else. We take care to ensure that all of our listings represent solid investment opportunities with the potential for excellent returns.</p>

                                                    <p>
                                                    While there are a number of investment companies in the marketplace that artificially inflate prices to increase profit margins, we are committed to providing our customers with fair market value. Our goal is always to identify the right investment property for you, to assess the current market opportunities and match these to your specific requirements and criteria.</p>
                                            </div>
                                        </div>
                                        <div class="g5plus-space space-5f02f8e97b45a" data-id="5f02f8e97b45a" data-tablet="80" data-tablet-portrait="60" data-mobile="50" data-mobile-landscape="50" style="clear: both; display: block; height: 100px"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script type='text/javascript' src='https://themes.g5plus.net/beyot/wp-content/plugins/beyot-framework/shortcodes/counter/assets/js/countUp.min.js?ver=5.3.4'></script>
